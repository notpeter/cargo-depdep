...
```console
4 additional transitive dependency changes not shown; use --transitive to show them
```

Pass `--transitive` to include those packages in the table.
...
of the manifest so that additions and removals are included. Resolved npm
